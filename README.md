...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[heaptrack](https://github.com/KDE/heaptrack)|A heap memory profiler for Linux|KDE|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[blaze](https://github.com/blenderskool/blaze)|⚡ File sharing progressive web app built using WebTorrent and WebSockets|blenderskool|
|[pancake](https://github.com/Rich-Harris/pancake)|Experimental charting library for Svelte|Rich-Harris|
|[blog](https://github.com/frankmcsherry/blog)|Some notes on things I find interesting and important.|frankmcsherry|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[litequeue](https://github.com/litements/litequeue)|Queue built on top of SQLite|litements|

# Other

|Repository|Description|Author|
| :--- | :--- | :--- |
|[best-of-ml-python](https://github.com/ml-tooling/best-of-ml-python)|🏆 A ranked list of awesome machine learning Python libraries. Updated weekly.|ml-tooling|
|[dashboard](https://github.com/dtolnay/dashboard)||dtolnay|
|[awesome-db-tools](https://github.com/mgramin/awesome-db-tools)|Everything that makes working with databases easier|mgramin|
|[gitignore](https://github.com/github/gitignore)|A collection of useful .gitignore templates|github|
|[Mathematics-for-ML](https://github.com/dair-ai/Mathematics-for-ML)|🧮  A collection of resources to learn mathematics for machine learning|dair-ai|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[software-papers](https://github.com/facundoolano/software-papers)|📚 A curated list of papers for Software Engineers|facundoolano|
|[dooit](https://github.com/kraanzu/dooit)|A TUI todo manager|kraanzu|
|[gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard)|Modular visual interface for GDB in Python|cyrus-and|
|[mistune](https://github.com/lepture/mistune)|A fast yet powerful Python Markdown parser with renderers and plugins.|lepture|
|[open-data-registry](https://github.com/awslabs/open-data-registry)|A registry of publicly available datasets on AWS|awslabs|
|[Kats](https://github.com/facebookresearch/Kats)|Kats, a kit to analyze time series data, a lightweight, easy-to-use, generalizable, and extendable framework to perform time series analysis, from understanding the key statistics and characteristics, detecting change points and anomalies, to forecasting future trends. |facebookresearch|
|[d2l-en](https://github.com/d2l-ai/d2l-en)|Interactive deep learning book with multi-framework code, math, and discussions. Adopted at 300 universities from 55 countries including Stanford, MIT, Harvard, and Cambridge.|d2l-ai|
|[datamodel-code-generator](https://github.com/koxudaxi/datamodel-code-generator)|Pydantic model generator for easy conversion of JSON, OpenAPI, JSON Schema, and YAML data sources.|koxudaxi|
|[linux-insides](https://github.com/0xAX/linux-insides)|A little bit about a linux kernel|0xAX|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[vim-markdown-composer](https://github.com/euclio/vim-markdown-composer)|An asynchronous markdown preview plugin for Vim and Neovim.|euclio|
|[xlite](https://github.com/x2bool/xlite)|SQLite extension to query Excel (.xlsx, .xls, .ods) files as virtual tables|x2bool|
|[cheats.rs](https://github.com/ralfbiedert/cheats.rs)|Rust Language Cheat Sheet - https://cheats.rs|ralfbiedert|
