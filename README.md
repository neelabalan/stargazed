...
|[hanko](https://github.com/teamhanko/hanko)|Authentication and User Management solution for developers. Open source alternative to Clerk & Auth0.|teamhanko|
...
|[whenever](https://github.com/ariebovenberg/whenever)|⏰ Modern datetime library for Python|ariebovenberg|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[kanata](https://github.com/jtroo/kanata)|Improve keyboard comfort and usability with advanced customization|jtroo|
...
|[screenpipe](https://github.com/mediar-ai/screenpipe)|rewind.ai x cursor.com = your AI assistant that has all the context|mediar-ai|
...
|Repository|Description|Author|
| :--- | :--- | :--- |
|[jazz](https://github.com/gardencmp/jazz)|Build your next app with sync.|gardencmp|
|[number-flow](https://github.com/barvian/number-flow)|A component to transition, format, and localize numbers.|barvian|
